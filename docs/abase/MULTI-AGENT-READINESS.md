...
- **Keyword menu**: when input is needed, agent shows keywords; user replies with keyword (or uses Cursor Command/script). Full prompts in **.cursor/rules/abase-agent-prompts-by-keyword.mdc**.
